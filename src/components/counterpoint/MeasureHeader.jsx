...
export default function MeasureHeader({
  ...
  return (
    <div
      className={`flex-shrink-0 flex items-center justify-start pl-2 text-sm font-semibold relative overflow-visible sticky top-0 z-30 ${measureIndex > 0 ? 'border-l-2 border-l-slate-600' : ''}`}
