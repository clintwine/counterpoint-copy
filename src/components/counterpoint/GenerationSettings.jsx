  ...
  return (
    <div className="bg-slate-800/40 rounded-xl p-5 border border-slate-700/50">
      ...
      <div className="space-y-5">
        {/* Species Selection */}
        <div>
          <Label className="text-white/90 text-xs mb-2 block font-medium">Species</Label>
          <Select
              ...
              {SPECIES_OPTIONS.map(option => (
                <SelectItem key={option.value} value={option.value} className="text-cream">
                  <div>
                    ...
                    <span className="text-white/60 ml-2 text-xs">— {option.description}</span>
                  </div>
                </SelectItem>
              ))}
            </SelectContent>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <Label className="text-white/90 text-xs mb-2 block font-medium">Key</Label>
            <Select
              value={settings.key}
          ...
          <div>
            <Label className="text-white/90 text-xs mb-2 block font-medium">Mode</Label>
            <Select
              value={settings.mode}
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <Label className="text-white/90 text-xs font-medium">Measures</Label>
            <span className="text-white font-mono text-sm">{settings.measures}</span>
          </div>
          <Slider
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <Label className="text-white/90 text-xs font-medium">Number of Voices</Label>
            <span className="text-white font-mono text-sm">{settings.numVoices}</span>
          </div>
          <Slider
        ...
        <div className="space-y-3 pt-2 border-t border-slate-700/50">
          <div className="flex items-center justify-between">
            <Label className="text-white/90 text-sm">Strict Rules</Label>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <Label className="text-white/90 text-sm">Show Violations</Label>
            <Switch
