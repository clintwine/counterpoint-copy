  ...
  return (
    <>
      ...
      <div className="flex items-center gap-2 justify-center">
        ...
        <div className="flex items-center bg-[#1A1A1A] rounded-md border border-[#3A3A3A] pl-3 pr-0.5 py-0.5 gap-1">
        ...
        <div className="flex items-center bg-[#1A1A1A] rounded-md border border-[#3A3A3A] pl-3 pr-4 py-1">
