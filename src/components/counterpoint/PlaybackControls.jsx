        ...
        <div className="flex items-center bg-[#1A1A1A] rounded-md border border-[#3A3A3A] p-0.5 gap-1">
          ...
          <div className="flex flex-col items-start justify-center">
            <Select value={timeSignature} onValueChange={onTimeSignatureChange}>
              <SelectTrigger className="h-auto w-12 bg-transparent border-none text-white text-sm font-medium px-1 hover:bg-[#2D2D2D] py-0 -mt-1">
                <SelectValue />
              </SelectTrigger>
            ...
            <span className="text-white/40 text-[9px] uppercase tracking-wider leading-none mt-2">SIG</span>
          </div>
        </div>
